...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="{{ route('student.profile.update') }}" class="space-y-5">
            ...
            <p class="text-xs font-bold text-gray-400 uppercase tracking-wider pb-1 border-b border-gray-100">Account Information</p>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="address" rows="2"
                              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#004D98] bg-gray-50 focus:bg-white">{{ old('address', $student->address) }}</textarea>
                </div>
            </div>

            <p class="text-xs font-bold text-gray-400 uppercase tracking-wider pb-1 border-b border-gray-100 pt-2">Change Password <span class="font-normal text-gray-400 normal-case">(leave blank to keep current)</span></p>
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="{{ route('student.portal') }}" class="px-6 py-2.5 border border-gray-200 text-gray-600 rounded-xl hover:bg-gray-50 transition text-sm">Cancel</a>
            </div>
        </form>
    </div>
</div>
