...
<div class="flex items-center justify-between mb-8 flex-wrap gap-3">
    ...
    <span class="text-xs bg-[#EDBB00] text-[#004D98] font-bold px-3 py-1.5 rounded-full">
        {{ now()->format('D, M d Y') }}
    </span>
</div>
        ...
        <div class="divide-y divide-gray-50">
            ...
            <div class="px-6 py-3.5 flex items-center gap-4 hover:bg-gray-50 transition">
                ...
                <a href="{{ route('admin.applications.show',$app) }}"
                   class="flex-shrink-0 px-3 py-1.5 bg-[#004D98] text-white text-xs rounded-lg font-semibold hover:bg-[#003a73] transition">
                    Review
                </a>
            </div>
            @empty
            ...
            <div>
                <div class="flex justify-between text-xs mb-1">
                    <span class="font-semibold text-gray-700">
                        {{ $room->room_number }}
                        <span class="text-gray-400 font-normal">({{ $room->building }})</span>
                    </span>
